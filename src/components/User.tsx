...
export const User = ({ user, isInvited, clickInvite }: { user: UserType, isInvited: boolean, clickInvite: (userId: number)=>void  }) => (
  <li>
    <div>
    ...
    {isInvited
      ? <img className="action" src="/assets/minus.svg" alt="Action" onClick={()=> clickInvite(user.id)} />
      : <img className="action" src="/assets/plus.svg" alt="Action" onClick={()=> clickInvite(user.id)} />
    }
